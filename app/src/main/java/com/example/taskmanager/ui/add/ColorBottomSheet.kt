...
class ColorBottomSheet : BottomSheetDialogFragment() {
    ...
    fun onColorSelected(v: View) {
        val color = when (v.id) {
            ...
            R.id.color8 -> Color.parseColor("#00251a")
            R.id.color9 -> Color.parseColor("#00251a")
            R.id.color10 -> Color.parseColor("#00251a")
            R.id.color11 -> Color.parseColor("#00251a")
            R.id.color12 -> Color.parseColor("#00251a")
            R.id.color13 -> Color.parseColor("#00251a")
            else  -> Color.parseColor("#00251a")
        }
